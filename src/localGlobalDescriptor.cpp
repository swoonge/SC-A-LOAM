...
ros::Publisher pubDescriptor, pubKeyregionDisplay;
    ...
    while (ros::ok) {
        ...
        while (SorroundQue.size() != 0) {
            ...
            *globalregienforDisplay += *SorroundPC;
            ...
            cout << "[KeypointDescriptorDetectionProcess] 처리한 point 수: " << pointDescriptorProcessedCount << " || 남은 수: " << SorroundQue.size() << endl;
        }
        rate.sleep();
    }
